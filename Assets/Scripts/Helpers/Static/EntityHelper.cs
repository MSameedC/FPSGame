...
public static class EntityHelper
{
    ...
    public static int EntityInRange(Vector3 pos, float detectRadius, Collider[] colliders, LayerMask layerMask)
    {
        var size = Physics.OverlapSphereNonAlloc(pos, detectRadius, colliders, layerMask);
        return size;
    }
}